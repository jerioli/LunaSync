...
const Settings = () => {
  ...
  const [healthcareProfessionalsPreview, setHealthcareProfessionalsPreview] =
    useState<string | null>(null);
  const [clinicBuildingPreview, setClinicBuildingPreview] = useState<
    string | null
  >(null);
    ...
    const fetchSettings = async () => {
      ...
      try {
        ...
        if (res.data) {
          ...
          setFaqs(
            res.data.faqs && res.data.faqs.length
              ? res.data.faqs
              : [{ question: "", answer: "" }],
          );
          setReviews(
            res.data.reviews && res.data.reviews.length
              ? res.data.reviews
              : [{ name: "", rating: 5, comment: "", date: "" }],
          );
          setLogoPreview(res.data.logo || null);
          setHealthcareProfessionalsPreview(
            res.data.healthcare_professionals_image || null,
          );
        ...
        toast({
          title: "Error",
          description: "Failed to fetch clinic settings",
          variant: "destructive",
        });
      } finally {
        setLoading(false);
      ...
      <div className="flex items-center justify-center h-full">
        <Card className="w-[400px]">
          <CardHeader>
            ...
            <CardDescription>
              Only administrators and superadministrators can access clinic
              settings.
            </CardDescription>
          </CardHeader>
        </Card>
  ...
  const handleGeneralSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      toast({
        ...
        description:
          "Your general clinic settings have been updated successfully.",
      });
      setIsEditing(false);
    } catch (err: any) {
  ...
  const handleImageChange = async (
    ...
    try {
      ...
      toast({
        title: "Error",
        description: `Failed to update ${field.replace(/_/g, " ")}`,
        variant: "destructive",
      });
    } finally {
      setLoading(false);
  ...
  const handleColorChange = (
    colorType: "primaryColor" | "secondaryColor" | "tertiaryColor",
    value: string,
  ) => {
  ...
  const handleResetBranding = () => {
    ...
    try {
      ...
      setTempColors({
        primaryColor: "#068406",
        secondaryColor: "#087733",
        tertiaryColor: "#6fca8f",
      });
      toast({
        title: "Colors Reset",
  ...
  const handleRunBatchTests = () => {
    ...
    toast({
      title: "Batch Testing",
      description:
        "Use run_security_tests.bat from your capstone folder to run comprehensive tests.",
    });
  };
  ...
  return (
    <div className="space-y-4 sm:space-y-6 max-w-full overflow-x-hidden">
      ...
      <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full">
        <TabsList className="flex-wrap justify-start h-auto gap-1 sm:gap-2 p-1">
          <TabsTrigger
            value="general"
            className="transition-colors text-xs sm:text-sm px-2 sm:px-3"
            style={{
              backgroundColor:
                activeTab === "general" ? colors.primaryColor : undefined,
          ...
          <TabsTrigger
            ...
            style={{
              backgroundColor:
                activeTab === "branding" ? colors.primaryColor : undefined,
          ...
          <TabsTrigger
            ...
            style={{
              backgroundColor:
                activeTab === "faqs" ? colors.primaryColor : undefined,
          ...
          <TabsTrigger
            ...
            style={{
              backgroundColor:
                activeTab === "homepage" ? colors.primaryColor : undefined,
              ...
              <CardContent className="space-y-3 sm:space-y-4 p-4 sm:p-6">
                ...
                <div>
                  ...
                  <p className="text-sm text-muted-foreground mt-1">
                    Get embed URL from Google Maps: Search your location → Share
                    → Embed a map → Copy HTML iframe src URL
                  </p>
                </div>
        ...
        <TabsContent value="branding">
          <Card>
            <CardHeader className="space-y-1 sm:space-y-2 p-4 sm:p-6">
              ...
              <CardDescription className="text-xs sm:text-sm">
                Customize the application colors and branding elements. Changes
                apply to all users across the entire application.
              </CardDescription>
            </CardHeader>
            <CardContent className="space-y-4 sm:space-y-6 p-4 sm:p-6">
              ...
              <div className="space-y-3">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                  <div
                    ...
                    style={{
                      backgroundColor: tempColors.primaryColor + "20",
                      borderColor: tempColors.primaryColor,
                    }}
                  >
                  ...
                  <div
                    className="p-4 rounded-lg border"
                    style={{
                      backgroundColor: tempColors.secondaryColor + "20",
                      borderColor: tempColors.secondaryColor,
                    }}
                  >
                    <div className="text-sm font-medium">
                  ...
                  <div
                    className="p-4 rounded-lg border"
                    style={{
                      backgroundColor: tempColors.tertiaryColor + "20",
                      borderColor: tempColors.tertiaryColor,
                    }}
                  >
                    <div className="text-sm font-medium">
                    ...
                    <Button
                      ...
                      style={{
                        borderColor: tempColors.tertiaryColor,
                        color: tempColors.tertiaryColor,
                      }}
                    >
                      Tertiary Button
                    </Button>
              ...
              <div className="space-y-4">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                    ...
                    {logoPreview && (
                      <div className="mt-2">
                        ...
                        <Button
                          ...
                          size="sm"
                          onClick={() =>
                            handleImageDelete("logo", setLogoPreview)
                          }
                          disabled={loading}
                  ...
                  <div>
                    <Label htmlFor="healthcare_professionals_image">
                    ...
                    {healthcareProfessionalsPreview && (
                      <div className="mt-2">
                        <img
                          src={healthcareProfessionalsPreview}
                          alt="Healthcare Professionals Preview"
                          className="h-16 object-contain mb-2"
                        />
                        <Button
                          variant="destructive"
                  ...
                  <div>
                    <Label htmlFor="clinic_building_image">
                    ...
                    {clinicBuildingPreview && (
                      <div className="mt-2">
                        <img
                          src={clinicBuildingPreview}
                          alt="Clinic Building Preview"
                          className="h-16 object-contain mb-2"
                        />
                        <Button
                          variant="destructive"
              ...
              <div className="bg-blue-50 p-4 rounded-lg">
                ...
                <ul className="text-sm space-y-1 text-muted-foreground">
                  <li>
                    • Only administrators can modify application colors and
                    branding
                  </li>
                  <li>
                    • Color changes are previewed in real-time but must be
                    applied to take effect
                  </li>
                  <li>
                    • Use "Apply Colors" to save changes, or "Cancel Changes" to
                    revert
                  </li>
                  <li>
                    • Images are uploaded instantly and can be deleted with the
                    trash button
                  </li>
                  <li>
                    • Use the reset button to return to default color scheme
                  </li>
                </ul>
              </div>
            </CardContent>
        ...
        <TabsContent value="faqs">
          <Card>
            ...
            <CardFooter className="flex justify-end">
              {!isEditingFaqs && (
                <Button type="button" onClick={() => setIsEditingFaqs(true)}>
                  Edit
                </Button>
              )}
              {isEditingFaqs && (
                ...
                <div className="space-y-4">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground mt-1">
                      ...
                      clinic emails (appointment confirmations, reminders,
                      review notifications, etc.)
                    </p>
                  </div>
                  <div className="flex items-center justify-between">
                    <div className="space-y-1">
                      <Label htmlFor="sendAppointmentConfirmations">
                  ...
                  <div className="flex items-center justify-between">
                    <div className="space-y-1">
                      <Label htmlFor="sendReviewNotifications">
                        Send Review Notifications
                      </Label>
                      <p className="text-sm text-muted-foreground">
                        Send notifications when patients submit reviews
                      </p>
                    </div>
                    <Switch
        ...
        <TabsContent value="homepage">
          <Card>
            <CardHeader className="space-y-1 sm:space-y-2 p-4 sm:p-6">
              ...
              <CardDescription className="text-xs sm:text-sm">
                Manage the main content of your clinic's homepage (Hero, About)
              </CardDescription>
            </CardHeader>
            <CardContent className="space-y-6 sm:space-y-8 p-4 sm:p-6">
              ...
              <div className="space-y-4 border-b pb-6">
                ...
                {isEditingHero && (
                  <Button className="mt-2" onClick={handleHeroSave}>
                    Save Hero Section
                  </Button>
                )}
              </div>
              ...
              <div className="space-y-4 border-b pb-6">
                ...
                {isEditingAbout && (
                  <Button className="mt-2" onClick={handleAboutSave}>
                    Save About Section
                  </Button>
                )}
              </div>
