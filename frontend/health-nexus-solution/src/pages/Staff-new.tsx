                    ...
                    <TableRow key={doctor.id}>
                      ...
                      <TableCell className="text-right">
                        <div className="flex justify-end space-x-2">
                          ...
                          <Button variant="outline" size="sm" onClick={() => handleEditStaff(doctor)}>
                ...
                <TableBody>
                  {filteredReceptionists.map(receptionist => (
                    <TableRow key={receptionist.id}>
                      ...
                      <TableCell>Front Office</TableCell>
                      <TableCell>
                        <div className="flex items-center space-x-1">
                          <Shield className="h-4 w-4 text-muted-foreground" />
                      ...
                      <TableCell className="text-right">
                        <div className="flex justify-end space-x-2">
                          <Button variant="outline" size="sm" onClick={() => handleViewDetails(receptionist)}>
                            <Eye className="h-4 w-4 mr-1" />
                            View Details
                          </Button>
                          <Button variant="outline" size="sm" onClick={() => handleEditStaff(receptionist)}>
                            <Edit className="h-4 w-4 mr-1" />
                            Edit
                          </Button>
                        </div>
                ...
                <TableBody>
                  {filteredAdmins.map(admin => (
                    <TableRow key={admin.id}>
                      ...
                      <TableCell className="text-right">
                        <div className="flex justify-end space-x-2">
                          <Button variant="outline" size="sm" onClick={() => handleViewDetails(admin)}>
                            <Eye className="h-4 w-4 mr-1" />
                            View Details
                          </Button>
                          <Button variant="outline" size="sm" onClick={() => handleEditStaff(admin)}>
                            <Edit className="h-4 w-4 mr-1" />
                            Edit
                          </Button>
                        </div>
