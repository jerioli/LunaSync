      ...
      <div className="flex flex-col h-screen">
          ...
          <Card className="h-[82vh] flex flex-col">              <CardHeader className="border-b">
                ...
                <div ref={personalRef} className="border p-4 rounded">
                  <h2 className="text-xl font-bold mb-4">Personal Information</h2>                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div>
                ...
                {isDoctor && (
                  <>                    <div ref={examRef} className="border p-4 rounded">
                      ...
                      <div className="mt-6">
                        <h3 className="font-semibold mb-2">Additional Notes</h3>                        <Label htmlFor="examNotes">Examination Notes</Label>                        <Textarea 
                          id="examNotes" 
                          rows={4}
