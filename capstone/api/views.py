...
# Redirect to frontend prescription viewer
def prescription_detail(request, prescription_id):
    # Redirect to frontend page that will render the prescription
    frontend_url = f"https://lunasync.site/prescription/{prescription_id}"
